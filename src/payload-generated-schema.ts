...
export const pages_blocks_internal_page = sqliteTable(
  'pages_blocks_internal_page',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_internal_page_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_internal_page_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_internal_page_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_internal_page_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_logo_strip_logos = sqliteTable(
  'pages_blocks_logo_strip_logos',
  {
    _order: integer('_order').notNull(),
    _parentID: text('_parent_id').notNull(),
    id: text('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_logo_strip_logos_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_logo_strip_logos_parent_id_idx').on(columns._parentID),
    pages_blocks_logo_strip_logos_logo_idx: index('pages_blocks_logo_strip_logos_logo_idx').on(
      columns.logo,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_logo_strip.id],
      name: 'pages_blocks_logo_strip_logos_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_logo_strip = sqliteTable(
  'pages_blocks_logo_strip',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_logo_strip_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_logo_strip_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_logo_strip_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_logo_strip_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const pages_blocks_kontaktai = sqliteTable(
  'pages_blocks_kontaktai',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: text('id').primaryKey(),
    companyName: text('company_name').default('II „ELNIS"'),
    companyCode: text('company_code').default('304153085'),
    vatCode: text('vat_code').default('LT100009868416'),
    bankAccount: text('bank_account').default('LT474010051003606689'),
    bankName: text('bank_name').default('Luminor Bank AS'),
    phone: text('phone').default('+370 623 06955'),
    email: text('email').default('info@elnis.lt'),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_kontaktai_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_kontaktai_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_kontaktai_path_idx').on(columns._path),
    pages_blocks_kontaktai_illustration_idx: index('pages_blocks_kontaktai_illustration_idx').on(
      columns.illustration,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_kontaktai_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_welcome_block_buttons = sqliteTable(
  'pages_blocks_welcome_block_buttons',
  {
    _order: integer('_order').notNull(),
    _parentID: text('_parent_id').notNull(),
    id: text('id').primaryKey(),
    text: text('text'),
    link: text('link'),
    hexColor: text('hex_color').default('#FF5733'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_welcome_block_buttons_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_welcome_block_buttons_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_welcome_block.id],
      name: 'pages_blocks_welcome_block_buttons_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_welcome_block = sqliteTable(
  'pages_blocks_welcome_block',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: text('id').primaryKey(),
    title: text('title').default('Sveiki atvykę! Pasirinkite jus dominančią temą:'),
    blockName: text('block_name'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_welcome_block_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_welcome_block_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_welcome_block_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_welcome_block_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_word_press_blog = sqliteTable(
  'pages_blocks_word_press_blog',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: text('id').primaryKey(),
    blockName: text('block_name'),
    wordpressUrl: text('wordpress_url').default('https://www.elnis.lt/wp-json/wp/v2/posts'),
    postsPerPage: numeric('posts_per_page').default('10'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_word_press_blog_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_word_press_blog_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_word_press_blog_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_word_press_blog_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v_blocks_internal_page = sqliteTable(
  '_pages_v_blocks_internal_page',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_internal_page_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_internal_page_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_internal_page_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_internal_page_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_logo_strip_logos = sqliteTable(
  '_pages_v_blocks_logo_strip_logos',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: integer('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_logo_strip_logos_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_logo_strip_logos_parent_id_idx').on(columns._parentID),
    _pages_v_blocks_logo_strip_logos_logo_idx: index(
      '_pages_v_blocks_logo_strip_logos_logo_idx',
    ).on(columns.logo),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_logo_strip.id],
      name: '_pages_v_blocks_logo_strip_logos_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_logo_strip = sqliteTable(
  '_pages_v_blocks_logo_strip',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_logo_strip_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_logo_strip_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_logo_strip_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_logo_strip_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v_blocks_kontaktai = sqliteTable(
  '_pages_v_blocks_kontaktai',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_kontaktai_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_kontaktai_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_kontaktai_path_idx').on(columns._path),
    _pages_v_blocks_kontaktai_illustration_idx: index(
      '_pages_v_blocks_kontaktai_illustration_idx',
    ).on(columns.illustration),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_kontaktai_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_welcome_block_buttons = sqliteTable(
  '_pages_v_blocks_welcome_block_buttons',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: integer('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_welcome_block_buttons_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_welcome_block_buttons_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_welcome_block.id],
      name: '_pages_v_blocks_welcome_block_buttons_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_welcome_block = sqliteTable(
  '_pages_v_blocks_welcome_block',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_welcome_block_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_welcome_block_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_welcome_block_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_welcome_block_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_word_press_blog = sqliteTable(
  '_pages_v_blocks_word_press_blog',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_word_press_blog_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_word_press_blog_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_word_press_blog_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_word_press_blog_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const footer_sections_buttons = sqliteTable(
  'footer_sections_buttons',
  {
    _order: integer('_order').notNull(),
    _parentID: text('_parent_id').notNull(),
    id: text('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('footer_sections_buttons_order_idx').on(columns._order),
    _parentIDIdx: index('footer_sections_buttons_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [footer_sections.id],
      name: 'footer_sections_buttons_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const footer_sections_links = sqliteTable(
  ...
  (columns) => ({
    _orderIdx: index('footer_sections_links_order_idx').on(columns._order),
    _parentIDIdx: index('footer_sections_links_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [footer_sections.id],
...
export const footer_sections = sqliteTable(
  'footer_sections',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: text('id').primaryKey(),
    title: text('title').notNull(),
    type: text('type', { enum: ['latest_posts', 'tag_cloud', 'custom_links'] }).notNull(),
  },
  (columns) => ({
    _orderIdx: index('footer_sections_order_idx').on(columns._order),
    _parentIDIdx: index('footer_sections_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [footer.id],
...
export const relations_pages_blocks_internal_page = relations(
  pages_blocks_internal_page,
  ({ one }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_internal_page._parentID],
      references: [pages.id],
      relationName: '_blocks_internalPage',
    }),
  }),
)
export const relations_pages_blocks_logo_strip_logos = relations(
  pages_blocks_logo_strip_logos,
  ({ one }) => ({
    _parentID: one(pages_blocks_logo_strip, {
      fields: [pages_blocks_logo_strip_logos._parentID],
      references: [pages_blocks_logo_strip.id],
      relationName: 'logos',
    }),
    logo: one(media, {
      fields: [pages_blocks_logo_strip_logos.logo],
      references: [media.id],
      relationName: 'logo',
    }),
  }),
)
export const relations_pages_blocks_logo_strip = relations(
  pages_blocks_logo_strip,
  ({ one, many }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_logo_strip._parentID],
      references: [pages.id],
      relationName: '_blocks_logoStrip',
    }),
    logos: many(pages_blocks_logo_strip_logos, {
      relationName: 'logos',
    }),
  }),
)
...
export const relations_pages_blocks_kontaktai = relations(pages_blocks_kontaktai, ({ one }) => ({
  _parentID: one(pages, {
    fields: [pages_blocks_kontaktai._parentID],
    references: [pages.id],
    relationName: '_blocks_kontaktai',
  }),
  illustration: one(media, {
    fields: [pages_blocks_kontaktai.illustration],
    references: [media.id],
    relationName: 'illustration',
  }),
}))
export const relations_pages_blocks_welcome_block_buttons = relations(
  pages_blocks_welcome_block_buttons,
  ({ one }) => ({
    _parentID: one(pages_blocks_welcome_block, {
      fields: [pages_blocks_welcome_block_buttons._parentID],
      references: [pages_blocks_welcome_block.id],
      relationName: 'buttons',
    }),
  }),
)
export const relations_pages_blocks_welcome_block = relations(
  pages_blocks_welcome_block,
  ({ one, many }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_welcome_block._parentID],
      references: [pages.id],
      relationName: '_blocks_welcomeBlock',
    }),
    buttons: many(pages_blocks_welcome_block_buttons, {
      relationName: 'buttons',
    }),
  }),
)
export const relations_pages_blocks_word_press_blog = relations(
  pages_blocks_word_press_blog,
  ({ one }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_word_press_blog._parentID],
      references: [pages.id],
      relationName: '_blocks_wordPressBlog',
    }),
  }),
)
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  _blocks_internalPage: many(pages_blocks_internal_page, {
    relationName: '_blocks_internalPage',
  }),
  _blocks_logoStrip: many(pages_blocks_logo_strip, {
    relationName: '_blocks_logoStrip',
  }),
  _blocks_testimonials: many(pages_blocks_testimonials, {
    relationName: '_blocks_testimonials',
  }),
  _blocks_kontaktai: many(pages_blocks_kontaktai, {
    relationName: '_blocks_kontaktai',
  }),
  _blocks_welcomeBlock: many(pages_blocks_welcome_block, {
    relationName: '_blocks_welcomeBlock',
  }),
  _blocks_wordPressBlog: many(pages_blocks_word_press_blog, {
    relationName: '_blocks_wordPressBlog',
  }),
...
export const relations__pages_v_blocks_internal_page = relations(
  _pages_v_blocks_internal_page,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_internal_page._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_internalPage',
    }),
  }),
)
export const relations__pages_v_blocks_logo_strip_logos = relations(
  _pages_v_blocks_logo_strip_logos,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_logo_strip, {
      fields: [_pages_v_blocks_logo_strip_logos._parentID],
      references: [_pages_v_blocks_logo_strip.id],
      relationName: 'logos',
    }),
    logo: one(media, {
      fields: [_pages_v_blocks_logo_strip_logos.logo],
      references: [media.id],
      relationName: 'logo',
    }),
  }),
)
export const relations__pages_v_blocks_logo_strip = relations(
  _pages_v_blocks_logo_strip,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_logo_strip._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_logoStrip',
    }),
    logos: many(_pages_v_blocks_logo_strip_logos, {
      relationName: 'logos',
    }),
  }),
)
...
export const relations__pages_v_blocks_kontaktai = relations(
  _pages_v_blocks_kontaktai,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_kontaktai._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_kontaktai',
    }),
    illustration: one(media, {
      fields: [_pages_v_blocks_kontaktai.illustration],
      references: [media.id],
      relationName: 'illustration',
    }),
  }),
)
export const relations__pages_v_blocks_welcome_block_buttons = relations(
  _pages_v_blocks_welcome_block_buttons,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_welcome_block, {
      fields: [_pages_v_blocks_welcome_block_buttons._parentID],
      references: [_pages_v_blocks_welcome_block.id],
      relationName: 'buttons',
    }),
  }),
)
export const relations__pages_v_blocks_welcome_block = relations(
  _pages_v_blocks_welcome_block,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_welcome_block._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_welcomeBlock',
    }),
    buttons: many(_pages_v_blocks_welcome_block_buttons, {
      relationName: 'buttons',
    }),
  }),
)
export const relations__pages_v_blocks_word_press_blog = relations(
  _pages_v_blocks_word_press_blog,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_word_press_blog._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_wordPressBlog',
    }),
  }),
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  _blocks_internalPage: many(_pages_v_blocks_internal_page, {
    relationName: '_blocks_internalPage',
  }),
  _blocks_logoStrip: many(_pages_v_blocks_logo_strip, {
    relationName: '_blocks_logoStrip',
  }),
  _blocks_testimonials: many(_pages_v_blocks_testimonials, {
    relationName: '_blocks_testimonials',
  }),
  _blocks_kontaktai: many(_pages_v_blocks_kontaktai, {
    relationName: '_blocks_kontaktai',
  }),
  _blocks_welcomeBlock: many(_pages_v_blocks_welcome_block, {
    relationName: '_blocks_welcomeBlock',
  }),
  _blocks_wordPressBlog: many(_pages_v_blocks_word_press_blog, {
    relationName: '_blocks_wordPressBlog',
  }),
...
export const relations_footer_sections_buttons = relations(footer_sections_buttons, ({ one }) => ({
  _parentID: one(footer_sections, {
    fields: [footer_sections_buttons._parentID],
    references: [footer_sections.id],
    relationName: 'buttons',
  }),
}))
export const relations_footer_sections_links = relations(footer_sections_links, ({ one }) => ({
  _parentID: one(footer_sections, {
...
export const relations_footer_sections = relations(footer_sections, ({ one, many }) => ({
  _parentID: one(footer, {
    fields: [footer_sections._parentID],
    references: [footer.id],
    relationName: 'sections',
  }),
  buttons: many(footer_sections_buttons, {
    relationName: 'buttons',
  }),
...
type DatabaseSchema = {
  ...
  pages_blocks_internal_page: typeof pages_blocks_internal_page
  pages_blocks_logo_strip_logos: typeof pages_blocks_logo_strip_logos
  pages_blocks_logo_strip: typeof pages_blocks_logo_strip
  ...
  pages_blocks_kontaktai: typeof pages_blocks_kontaktai
  pages_blocks_welcome_block_buttons: typeof pages_blocks_welcome_block_buttons
  pages_blocks_welcome_block: typeof pages_blocks_welcome_block
  pages_blocks_word_press_blog: typeof pages_blocks_word_press_blog
  pages: typeof pages
  ...
  _pages_v_blocks_internal_page: typeof _pages_v_blocks_internal_page
  _pages_v_blocks_logo_strip_logos: typeof _pages_v_blocks_logo_strip_logos
  _pages_v_blocks_logo_strip: typeof _pages_v_blocks_logo_strip
  ...
  _pages_v_blocks_kontaktai: typeof _pages_v_blocks_kontaktai
  _pages_v_blocks_welcome_block_buttons: typeof _pages_v_blocks_welcome_block_buttons
  _pages_v_blocks_welcome_block: typeof _pages_v_blocks_welcome_block
  _pages_v_blocks_word_press_blog: typeof _pages_v_blocks_word_press_blog
  ...
  footer_sections_buttons: typeof footer_sections_buttons
  ...
  relations_pages_blocks_internal_page: typeof relations_pages_blocks_internal_page
  relations_pages_blocks_logo_strip_logos: typeof relations_pages_blocks_logo_strip_logos
  relations_pages_blocks_logo_strip: typeof relations_pages_blocks_logo_strip
  ...
  relations_pages_blocks_kontaktai: typeof relations_pages_blocks_kontaktai
  relations_pages_blocks_welcome_block_buttons: typeof relations_pages_blocks_welcome_block_buttons
  relations_pages_blocks_welcome_block: typeof relations_pages_blocks_welcome_block
  relations_pages_blocks_word_press_blog: typeof relations_pages_blocks_word_press_blog
  ...
  relations__pages_v_blocks_internal_page: typeof relations__pages_v_blocks_internal_page
  relations__pages_v_blocks_logo_strip_logos: typeof relations__pages_v_blocks_logo_strip_logos
  relations__pages_v_blocks_logo_strip: typeof relations__pages_v_blocks_logo_strip
  ...
  relations__pages_v_blocks_kontaktai: typeof relations__pages_v_blocks_kontaktai
  relations__pages_v_blocks_welcome_block_buttons: typeof relations__pages_v_blocks_welcome_block_buttons
  relations__pages_v_blocks_welcome_block: typeof relations__pages_v_blocks_welcome_block
  relations__pages_v_blocks_word_press_blog: typeof relations__pages_v_blocks_word_press_blog
  ...
  relations_footer_sections_buttons: typeof relations_footer_sections_buttons
